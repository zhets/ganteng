...
sleep 1
echo -e "[ ${tyblue}NOTES${NC} ] Auto Script VPS By XDXL STORE"
sleep 1
...
───│    $Green┴ ┴└─┘ ┴ └─┘└─┘└─┘┴└─┴┴   ┴   ┴─┘┴ ┴ └─┘$NC   │───
    ...
    └───────────────────────────────────────────────┘
          ${RED} SCRIPT VPS AUTO INSTALL ${FONT}    
...
sudo apt install -y at screen curl jq bzip2 gzip coreutils rsyslog iftop \
 ...
 socat cron bash-completion pwgen netcat cron zip ntpdate xz-utils sudo apt-transport-https \
...
wget -q https://raw.githubusercontent.com/zhets/ScriptAutoInstall-Xdxl/main/bbr.sh
chmod +x bbr.sh && ./bbr.sh
function pasang_domain() {
clear
LOGO
echo -e "${y}────────────────────────────────────────────────${NC}"
echo -e "                ${ungu} XDXL VPN STORE ${NC}"
echo -e "${y}────────────────────────────────────────────────${NC}"
...
wget -q https://github.com/zhets/ScriptAutoInstall-Xdxl/raw/main/autopointing.sh
chmod +x autopointing.sh && ./autopointing.sh pointing_domain.xd
rm -f /root/autopointing.sh
else
...
sleep 2
clear
wget https://raw.githubusercontent.com/zhets/ganteng/main/ssh-vpn.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/zhets/ganteng/main/ins-xray.sh
chmod +x ins-xray.sh && ./ins-xray.sh
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green          Install Websocket Proxy        $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
